...
class MainViewController: UITabBarController {
    ...
    let popularActorsViewController: ViewController? = nil
...
//        self.setupView()
    ...
    func setupView(){
        ...
        popularActorsViewController?.tabBarItem = UITabBarItem(title: nil, image: #imageLiteral(resourceName: "sessionIcon") , tag: 0)
